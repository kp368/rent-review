...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'reviews_review', 'rating')

        # Adding field 'Review.title'
        db.add_column(u'reviews_review', 'title',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Review.date'
        db.add_column(u'reviews_review', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 1, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Review.rating'
        db.add_column(u'reviews_review', 'rating',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3),
                      keep_default=False)

        # Deleting field 'Review.title'
        db.delete_column(u'reviews_review', 'title')

        # Deleting field 'Review.date'
        db.delete_column(u'reviews_review', 'date')
    ...
    models = {
        ...
        u'reviews.review': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reviews.Property']"}),
