...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reviews_property', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('address', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'reviews', ['Property'])
        ...
        db.create_table(u'reviews_review', (
            ...
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews.Property'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'reviews_property')
